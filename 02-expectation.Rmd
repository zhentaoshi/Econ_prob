...
Lebesgue integral is a more general approach to defining integration. It is
...
despite that we cannot completely foresee the realization of a random variable in a particular trial
...
The moment is a function of the probability function. To back out the underlying distribution
